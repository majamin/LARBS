#!/bin/sh
# Modified from LARBS by Luke Smith (larbs.xyz)
# License: GNU GPLv3
...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/majamin/autoarch.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/majamin/LARBS/master/progs.csv"
